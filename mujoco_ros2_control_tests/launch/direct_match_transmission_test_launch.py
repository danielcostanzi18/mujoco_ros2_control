...
def launch_setup(context, *args, **kwargs):
    ...
    parameters_file = PathJoinSubstitution([pkg_share, "config", "direct_match_transmission_controllers.yaml"])

    robot_description_content = Command(
        [
            PathJoinSubstitution([FindExecutable(name="xacro")]),
            " ",
            PathJoinSubstitution([pkg_share, "test_resources", "robot", "direct_match_transmission_robot.urdf"]),
            " headless:=",
    ...
    for controller in ["joint_state_broadcaster", "position_controller"]:
        nodes.append(
            Node(
